...
| iOS participant/release support | **Deferred** | An iOS 14+ prototype now exists, but it is unsigned, has no guaranteed continuous camera operation after backgrounding, and has not completed a physical-device supervised trial. Keep it out of participant releases until those evidence gates pass. |
