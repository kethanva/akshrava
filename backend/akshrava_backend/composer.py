...
TEMPLATES_TA = {
    ...
    "look_clear": "சமீபத்திய பார்வையில் எச்சரிக்கை எதுவுமில்லை. தொடர்ந்து கைத்தடி அல்லது வழிகாட்டியைப் பயன்படுத்தவும்", "look_unavailable": "தற்போது சரிபார்க்க முடியவில்லை, மீண்டும் முயற்சிக்கவும்",
}
TEMPLATES_KN = {
    ...
    "look_clear": "ಇತ್ತೀಚಿನ ದೃಶ್ಯದಲ್ಲಿ ಎಚ್ಚರಿಕೆ ಇಲ್ಲ. ಬೆತ್ತ ಅಥವಾ ಮಾರ್ಗದರ್ಶಿಯನ್ನು ಬಳಸುವುದನ್ನು ಮುಂದುವರಿಸಿ", "look_unavailable": "ಈಗ ಪರಿಶೀಲಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ, ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ",
}
TEMPLATES_ML = {
    ...
    "look_clear": "സമീപകാല കാഴ്ചയിൽ മുന്നറിയിപ്പില്ല. വടിയോ വഴികാട്ടിയോ ഉപയോഗിക്കുന്നത് തുടരുക", "look_unavailable": "ഇപ്പോൾ പരിശോധിക്കാൻ കഴിഞ്ഞില്ല, വീണ്ടും ശ്രമിക്കുക",
}
TEMPLATES_TE = {
    ...
    "look_clear": "ఇటీవలి దృశ్యంలో హెచ్చరిక లేదు. కర్ర లేదా గైడ్‌ను ఉపయోగించడం కొనసాగించండి", "look_unavailable": "ఇప్పుడు తనిఖీ చేయలేకపోయాం, మళ్లీ ప్రయత్నించండి",
}
